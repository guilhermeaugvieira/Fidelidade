...
public class AddressValidation : BaseEntityValidation<Address>
{
    public AddressValidation()
    {
        RuleFor(c => c.State)
            ...
            .Length(2).WithMessage("The filed {PropertyName} must have {ComparisonValue} characters");
        ...
        RuleFor(c => c.CEP)
            .NotEmpty().WithMessage("The field {PropertyName} must be filled")
            .Length(9).WithMessage("The filed {PropertyName} must have {ComparisonValue} characters");
